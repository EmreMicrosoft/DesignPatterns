...
The latest addition is POSA Volume 2's Scoped Locking pattern: a lock protects
shared state for exactly the lexical scope of an update and is then released.
...
all 253 records. Search or filter the cards, switch between English and
