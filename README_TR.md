...
Design Patterns, eksiksiz POSA Volume 1 kataloğu ve seçilmiş DDD, mimari ve
 eşzamanlılık desenlerini kapsayan; özgün olarak yazılmış, çalıştırılabilir 258
kayıtlı katalogdur.
...
En son eklenen Microservices.io Distributed Tracing desenidir: tek bir iz
kimliği, işbirliği yapan servislerin kaydettiği span'ları birleştirir.
...
[`web/index.html`](web/index.html), 258 kaydın tamamı için bağımlılıksız ve iki
