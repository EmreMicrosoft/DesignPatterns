...
An independently authored, executable catalogue of 262 design-pattern records.
...
| Python | `src/python/catalog.py` | Standard-library contracts for all 262 records |
| JavaScript | `src/javascript/catalog.js` | Node.js contracts for all 262 records |
| TypeScript | `src/typescript/catalog.ts` | Strictly typed contracts for all 262 records |
| C++ | `src/cpp/catalog.cpp` | C++20 contracts for all 262 records |
...
The script validates the 38 C# examples, all 262 Python, JavaScript and
