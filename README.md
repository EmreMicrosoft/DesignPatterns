...
| Python | `src/python/catalog.py` | Standard-library contracts for all 252 records |
| JavaScript | `src/javascript/catalog.js` | Node.js contracts for all 252 records |
| TypeScript | `src/typescript/catalog.ts` | Strictly typed contracts for all 252 records |
| C++ | `src/cpp/catalog.cpp` | C++20 contracts for all 252 records |
...
The script validates the 38 C# examples, all 252 Python, JavaScript and
